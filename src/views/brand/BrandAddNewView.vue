    ...
    <div>
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px"
            ...
            <el-form-item label="類別">
                <el-select v-model="ruleForm.categoryId" placeholder="請選擇對應分類名">
                    <el-option label="類別1" value="shanghai"></el-option>
                    <el-option label="類別2" value="beijing"></el-option>
                </el-select>
            </el-form-item>

            <el-form-item label="品牌簡介">
        ...
        data() {
            return {
                ...
                rules:{
                    ...
                    pinyin: [
                        {required: true, message: '請輸入品牌拼音', trigger: 'change'},
                        {min: 2, max: 25, message: '長度為 2 到 25 个字符', trigger: 'blur'}
                    ]
                    // sort: [
